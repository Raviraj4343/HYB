            ...
            {chats.map((chat, index) => {
              ...
              return (
                <motion.button
                  ...
                  className="flex w-full items-start gap-4 px-5 py-4 text-left transition hover:bg-muted/40 dark:hover:bg-white/[0.03] sm:px-6"
                >
                  <Avatar className="mt-0.5 h-14 w-14 border border-border/70 shadow-sm dark:border-white/10">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        <div className="truncate text-[1.02rem] font-semibold tracking-tight text-foreground dark:text-white">
                          {otherUser?.fullName}
                        </div>
                    ...
                    <div className="mt-2 flex items-start justify-between gap-3">
                      <div className="min-w-0 flex-1">
                        ...
                        {chat.request && (
                          <Badge variant="secondary" className="mt-2 rounded-full px-3 py-1 text-[11px] font-medium">
                            {chat.request.title}
                          </Badge>
                        )}
                      </div>
                      <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-border/70 bg-background/80 text-muted-foreground dark:border-white/10 dark:bg-white/[0.04]">
